...
def find_cars(img, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins,
    ...
    for xb in range(nxsteps):
        for yb in range(nysteps):
            ...
            # plt.imshow(subimg)
            # fig.tight_layout()
            # plt.savefig('../test_output/sub/subimg_'+str(index)+'.png')
            # plt.close(fig)
            ...
            if test_prediction == 1:
                ...
                windows.append(((xbox_left + xstart, ytop_draw + ystart), (xbox_left + xstart + win_draw, ytop_draw + win_draw + ystart)))
