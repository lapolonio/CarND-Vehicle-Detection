...
car_image = mpimg.imread('/Users/lapolonio/Downloads/train_data_set/vehicles/GTI_Left/image0377.png')
not_car_image = mpimg.imread('/Users/lapolonio/Downloads/train_data_set/non-vehicles/GTI/image6.png')
fig = plt.figure()
plt.subplot(121)
